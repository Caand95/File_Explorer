...
namespace FileExplorer.Logic.FileManager.Item
{
    class ItemFactory
    {
        ...
        //}
        #endregion
        internal static Folder CreateFolder(string path, string name, string size, string owner, FileType type, DateTime creationDate, bool writeProtection)
        {
            return new Folder(path, name, size, owner, type, creationDate, writeProtection);
        }
